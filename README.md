...
```
APP_ENV=development
CSV_PATH=crates/importer/cron_runner/data/merchants.csv
DATABASE_URL=postgres://postgres:postgres@localhost:5432/importer_db
...
DATABASE_URL=postgres://postgres:postgres@localhost:5432/importer_test_db
KAFKA_BROKERS=localhost:9092
```
...
- Make sure Docker containers are running before running tests or the importer.
